...
const So = ["Waiting", "Fabricating", "Ready To Load", "Hand Over", "Completed"];
const Ea = ["Intake", "Processed", "75% Invoice Submited", "Recived"];
const Qg = ["Pending", "Ongoing", "Ready For Inspection", "Revision", "Completed"];
...
const getColorClasses = (theme) => {
  switch (theme) {
    case "blue":
      return "bg-primary/10 text-primary hover:bg-primary/20 hover:text-primary border-blue-100/30 focus:ring-blue-500";
    case "emerald":
      return "bg-secondary/10 text-secondary hover:bg-secondary/20 hover:text-secondary border-emerald-100/30 focus:ring-emerald-500";
    case "amber":
      return "bg-primary/10 text-yellow-500 hover:bg-yellow-500/20 hover:text-primary border-yellow-500/30 focus:ring-amber-500";
    case "purple":
      return "bg-purple-50 text-purple-600 hover:bg-purple-100 hover:text-purple-700 border-purple-100/30 focus:ring-purple-500";
    case "indigo":
      return "bg-primary/10 text-primary hover:bg-primary/20 hover:text-primary border-indigo-100/30 focus:ring-primary";
    case "orange":
      return "bg-orange-50 text-orange-600 hover:bg-orange-100 hover:text-orange-700 border-orange-100/30 focus:ring-orange-500";
    case "rose":
      return "bg-error/10 text-error hover:bg-error/20 hover:text-error border-error/30 focus:ring-error";
    default:
      return "bg-surface-container-low text-on-surface-variant hover:bg-surface-container hover:text-on-surface border-outline-variant/50/30 focus:ring-slate-500";
  }
};
...
const Dashboard = ({
  ...
  const activeDealsCount = leads.filter(
    (lead) => lead.isDeal && So.includes(lead.stage) && lead.stage !== "Completed"
  ).length;
  ...
  const pendingRevenue = leads
    .filter((lead) => lead.isDeal && So.includes(lead.stage) && lead.stage !== "Completed")
  ...
  const trendData = [
    { month: "Jan", sales: 120000, production: 45 },
    { month: "Feb", sales: 150000, production: 52 },
    { month: "Mar", sales: 180000, production: 61 },
    { month: "Apr", sales: 140000, production: 48 },
    { month: "May", sales: 210000, production: 70 },
    { month: "Jun", sales: 250000, production: 85 },
    { month: "Jul", sales: 235000, production: 78 }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-primary/10 border border-primary/30 p-6 rounded-2xl text-on-surface shadow-[0_0_20px_rgba(0,218,243,0.15)] flex justify-between items-start relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-4xl font-extrabold text-on-surface font-display tracking-tight">LKR {pendingRevenue.toLocaleString()}</p>
            <p className="text-primary/70 text-xs mt-2 font-medium">
              From {activeDealsCount} active deal{activeDealsCount !== 1 ? "s" : ""}
            </p>
          </div>
          <TrendingUp size={40} className="text-primary opacity-60 relative z-10" />
        </div>
        ...
        <div className="bg-secondary/10 border border-secondary/30 p-6 rounded-2xl text-on-surface shadow-[0_0_20px_rgba(152,208,218,0.15)] flex justify-between items-start relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-4xl font-extrabold text-on-surface font-display tracking-tight">LKR {completedRevenue.toLocaleString()}</p>
            <p className="text-secondary/70 text-xs mt-2 font-medium">From closed deals</p>
          </div>
          <CircleCheckBig size={40} className="text-secondary opacity-60 relative z-10" />
        </div>
      </div>
      ...
      <div className="bg-surface-container p-5 rounded-2xl border border-outline-variant shadow-[0_4px_20px_rgba(0,218,243,0.05)]">
        <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center mb-6 gap-4 sm:gap-0">
          <div>
            ...
            <p className="text-[10px] text-on-surface-variant mt-1">Overview of revenue vs volume across recent months.</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-[10px] text-on-surface-variant mb-1">
            {leads.filter((lead) => Ea.includes(lead.stage)).length} total leads
          </p>
          <PipelineBar
            stages={Ea}
            data={leads.filter((lead) => Ea.includes(lead.stage))}
        ...
        >
          ...
          <p className="text-[10px] text-on-surface-variant mb-1">
            {leads.filter((lead) => So.includes(lead.stage)).length} total deals
          </p>
          <PipelineBar
            stages={So}
            data={leads.filter((lead) => So.includes(lead.stage))}
